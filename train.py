...
from utils import *
from loss import OriTripletLoss, TripletLoss_WRT, CenterTripletLoss,CenterLoss,KLalignloss_DIMA
from loss import QuarCenterTripletLoss as QuarCenterTripletLoss
...
if args.loss_tri == 'QCT':
    loader_batch = args.batch_size * args.num_pos
    criterion_tri = QuarCenterTripletLoss(k_size=4, margin=0.7)
...
def train(epoch):
    ...
    for batch_idx, (input10, input11, input20, input21, label1, label2) in enumerate(trainloader):
        ...
        with amp.autocast(enabled=True):
            ...
            # feat, out0, loss = net(input10, input11, input20, input21)    # v2
            feat, out0 = net(input10, input11, input20, input21)
